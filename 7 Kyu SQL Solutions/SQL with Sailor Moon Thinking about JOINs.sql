/* Practise some SQL fundamentals by making a simple database on a topic
you feel familiar with. Or use mine, populated with a wealth of Sailor Moon trivia.
...
containing each character's high school, their civilian name and the cat
